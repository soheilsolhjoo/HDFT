% [mesh_alpha,n,Q,lnA] = HD_f_sinh_conventional(CK,N,S,A,PO,sf):
...
% 'HDFT_fit.mat' as a stucture named "ST##" with ## being the assigned
% values of A.
%
...
% -------------------------------------------------------------------------
function [mesh_alpha,mesh_n,Q,lnA] = HD_f_sinh_conventional(varargin)
...
ave_n = HD_f_power_law(CK,100,0,0,'poly9',0);
ave_b = HD_f_exponential(CK,100,0,0,'poly9',0);
...
if saving_f
%     Data Structure
    HDFT_fit_temp.type = 3;
    data = ["input,call,para,poly,mesh,corr";
        "ss_approx,strain,strate,temp,u_rates,u_temp,index";
        "CK,N,strain_spec,averaging,p_order";
        "ave_alpha,n,Q,lnA,curves_n,curves_Q,ave_n,ave_Q,ave_lnA";
        "poly_alpha,poly_n,poly_Q,poly_lnA,c_alpha,c_n,c_Q,c_lnA";
        "mesh_strate,mesh_temp,mesh_n,mesh_Q,mesh_lnA,Z,mesh_alpha";
    ...
    toSave = strrep("ST" + num2str(averaging),' ','');
