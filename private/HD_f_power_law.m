% ave_n = HD_f_power_law(CK,N,S,A,PO,sf)
...
% on it, and save all calculations in 'HDFT_fit.mat' as a stucture named
% "PL#", with # being the assigned value of A: PL0 | PL1.
%
...
% -------------------------------------------------------------------------
function ave_n = HD_f_power_law(varargin)
...
if saving_f
%     Data Structure
    HDFT_fit_temp.type = 1;
    data = ["input,call,para,poly,mesh,corr";
        "ss_approx,strain,strate,temp,u_rates,u_temp,index";
        "CK,N,strain_spec,averaging,p_order";
        "n,Q,lnA,curves_n,curves_Q,ave_n,ave_Q,ave_lnA";
        "poly_n,poly_Q,poly_lnA,c_n,c_Q,c_lnA";
        "mesh_strate,mesh_temp,mesh_n,mesh_Q,mesh_lnA,Z";
