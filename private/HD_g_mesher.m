% HD_g_mesher is a general function of the Hot Deformation (HD) code. This 
% function takes various parameters as the input argument and create a
% representative mesh (2D matrix) of them. It also calculates the 
% Zenner-Holomon parameter.
% 
%% DISCLAIMER
